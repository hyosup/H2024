		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hkmccazucaa00020-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hkmccazucaa00020-display": {
								"semanticObject": "hkmccazucaa00020",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hkmc.ca.zucaa00020",
									"url": sap.ui.require.toUrl("hkmc/ca/zucaa00020")
								}
							}
						}
					}
