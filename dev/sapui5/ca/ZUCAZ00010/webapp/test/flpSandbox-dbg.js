		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAUI5 Library",
									"targetURL": "#hkmccazucaz00010-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hkmccazucaz00010-display": {
								"semanticObject": "hkmccazucaz00010",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hkmc.ca.zucaz00010",
									"url": sap.ui.require.toUrl("hkmc/ca/zucaz00010")
								}
							}
						}
					}
