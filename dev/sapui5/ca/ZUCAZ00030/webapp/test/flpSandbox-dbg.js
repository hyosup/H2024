		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hkmccazucaz00030-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hkmccazucaz00030-display": {
								"semanticObject": "hkmccazucaz00030",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hkmc.ca.zucaz00030",
									"url": sap.ui.require.toUrl("hkmc/gsi/zugsi00030")
								}
							}
						}
					}
