		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAUI5 Library",
									"targetURL": "#hkmccayyz00010-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hkmccayyz00010-display": {
								"semanticObject": "hkmccayyz00010",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hkmc.ca.yyz00010",
									"url": sap.ui.require.toUrl("hkmc/ca/yyz00010")
								}
							}
						}
					}
