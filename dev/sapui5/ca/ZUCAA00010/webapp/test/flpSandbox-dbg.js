		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Developer Comunity Management",
									"targetURL": "#hkmccazucaa00010-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hkmccazucaa00010-display": {
								"semanticObject": "hkmccazucaa00010",
								"action": "display",
								"description": "Developer Comunity Management",
								"title": "Developer Comunity Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hkmc.ca.zucaa00010",
									"url": sap.ui.require.toUrl("hkmc/ca/zucaa00010")
								}
							}
						}
					}
