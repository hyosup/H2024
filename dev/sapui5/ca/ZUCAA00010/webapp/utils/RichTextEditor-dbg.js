sap.ui.define([
	...
	"use strict";
	return RichTextEditor.extend("hkmc.ca.zucaa00010.utils.RichTextEditor", {
		metadata: {
			library: "hkmc.ca.zucaa00010",
			properties: {
				value: {
					type: "string",
					defaultValue: null
		...
		_createConfigTinyMCE: function(e) {
			...
			var oPlugin = "code table image imagetools link powerpaste preview textcolor ";
			oPlugin += "print search	replace save lists advlist charmap hr ";
