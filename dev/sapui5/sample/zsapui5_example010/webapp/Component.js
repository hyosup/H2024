sap.ui.define(
	...
	function (UIComponent, JSONModel, ODataModel, models,Currency) {
		"use strict";
		return UIComponent.extend("sap.ui.demo.walkthrough.Component", {
			...
			createContent : function() {
                ...
                // https://sapui5.hana.ondemand.com/1.108.29/#/api/sap.ui.Device.system%23properties
				let lv_isPhone = sap.ui.Device.system.phone;
				
				if(lv_isPhone){
					// create root view
                    var oView = sap.ui.view({
                        viewName : "sap.ui.demo.walkthrough.view.MApp",
			...
			init: function () {
                ...
                // set App model
                var sUrl = '/sap/opu/odata/sap/YTEST_ODATA02_SRV/';			
				...
				// 	// alert("lv_isPhone");
				// 	//Change root view
				// 	 this.getRootControl().setViewName("sap.ui.demo.walkthrough.view.MApp");
				// }
